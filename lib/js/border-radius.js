...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/styles.less":[function(require,module,exports) {
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.getComputedStyleValue = _this.getComputedStyleValue.bind(_assertThisInitialized(_this));
  ...
  _createClass(App, [{
    ...
    value: function handleChange(val) {
      var el = document.getElementById("face-after");
    ...
    value: function onLoad() {
      ...
      var attrs = ['border-radius', 'height', 'width', 'animation'];
      var el = attrs.reduce(function (a, v) {
        if (v === "animation" && _this2.getComputedStyleValue('#face-after', v).indexOf('none running') > 0) {
          return a += "";
        }

        return a += "".concat(v, ": ").concat(_this2.getComputedStyleValue('#face-after', v), ";\r\n");
      }, "");
      var input = document.getElementById('stylebox');
      input.value = el;
    }
  }, {
    key: "getComputedStyleValue",
    value: function getComputedStyleValue(sel, attr) {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        onChange: function onChange(e) {
          setTimeout(_this3.handleChange(e), 500);
        },
        type: "text"
      })), _react.default.createElement("div", {
        id: "face-after",
...
var rootElement = document.getElementById("border-radius");

_reactDom.default.render(_react.default.createElement(App, null), rootElement);
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./styles.less":"src/styles.less"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
